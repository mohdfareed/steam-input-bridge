...
namespace SteamInputBridge {
    ...
    class BridgeProtocolReader {
       public:
        ...
        static constexpr uint8_t FrameBufferSize = HeaderSize + MousePayloadSize + ChecksumSize;
        static constexpr uint8_t MouseFrameSize = HeaderSize + MousePayloadSize + ChecksumSize;
        ...
        static constexpr uint8_t HandshakeResponseFrameSize = HeaderSize + HandshakeResponsePayloadSize + ChecksumSize;
