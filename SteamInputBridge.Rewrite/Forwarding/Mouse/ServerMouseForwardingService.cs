...
public sealed partial class ServerMouseForwardingService(
    ...
    ILogger<ServerMouseForwardingService> logger) : IHostedService, IAsyncDisposable
{
    private readonly IMouseInputSourceFactory _inputFactory = inputFactory;
    private readonly IMouseOutputFactory _outputFactory = outputFactory;
    private readonly ILogger<ServerMouseForwardingService> _logger = logger;
