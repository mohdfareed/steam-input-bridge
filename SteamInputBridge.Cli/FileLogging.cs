...
{
    /// <summary>Adds file logging beside the CLI executable.</summary>
    public static ILoggingBuilder AddCliFileLogger(this ILoggingBuilder logging)
    {
    ...
    /// <summary>Gets the per-process log path beside the CLI executable.</summary>
