...
internal static class BridgeLog
{
    ...
    private static readonly Action<ILogger, int, string, Exception?> LogClientRegistered =
        LoggerMessage.Define<int, string>(
            LogLevel.Information,
            new EventId(8, nameof(LogClientRegistered)),
            "Client process {ProcessId} connected for profile {ProfileId}.");
    ...
    private static readonly Action<ILogger, string, Exception?> LogClientExitRequested =
        LoggerMessage.Define<string>(
            LogLevel.Information,
            new EventId(16, nameof(LogClientExitRequested)),
            "Client exit requested for profile {ProfileId}.");
    ...
    public static void ClientRegistered(ILogger logger, int processId, string profileId)
    {
        LogClientRegistered(logger, processId, profileId, null);
    }
    ...
    public static void ClientExitRequested(ILogger logger, string profileId)
    {
        LogClientExitRequested(logger, profileId, null);
    }
}
