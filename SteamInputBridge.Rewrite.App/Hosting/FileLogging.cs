...
internal static class FileLogging
{
    ...
    public static ILoggingBuilder AddApplicationFileLogger(this ILoggingBuilder logging, string? logDirectory)
    {
        ...
        _ = logging.Services.AddSingleton<ILoggerProvider>(_ => new FileLoggerProvider(ResolveRunLogFilePath(logDirectory)));
        return logging;
    }
